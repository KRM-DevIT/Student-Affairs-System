...
//========================================================================================
        ...
        this.PopulateRows(students, this.currentOnEdit, this.currentOnDelete); // view function to add the rows 
...
PopulateRows(students, currentOnEdit, currentOnDelete) 
{
...
//----------------------------------------------------Render Form----------------------------------------------------
    ...
    renderForm(student, onSave, onCancel) {
        ...
        if(student){
            h2.textContent = "Edit Student";
        } else {
            h2.textContent = "Add New Student"; 
        }
        ...
        //(label , type , id , value )
        form.appendChild(this.createInputDOM("ID", "number", "id", student?.id));   
        form.appendChild(this.createInputDOM("Name", "text", "name", student?.name));
        form.appendChild(this.createInputDOM("Email", "email", "email", student?.email));
        form.appendChild(this.createInputDOM("Department", "text", "department", student?.department));
        form.appendChild(this.createInputDOM("Age", "number", "age", student?.age));
        form.appendChild(this.createCheckboxDOM("Currently Enrolled", "enrolled", student?.enrolled)); //(label,id,value) different params so we need different function
        ...
        submitBtn.textContent = student ? "Update" : "Save";
